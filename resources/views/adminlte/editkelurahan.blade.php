        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('kelurahan') }}" class="btn btn-outline-secondary"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a></li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form class="px-4 pt-3" action="{{ route('update-kelurahan', ['kelurahan' => $kelurahan -> id]) }}" method="post">
                        ...
                        @endif
                      <button onclick="return confirm('Yakin ingin merubah data')" type="submit" class="btn btn-danger ml-4 mt-2" style="border: none;">Perbaharui <i class="fa fa-pen" aria-hidden="true"></i></button>
                    </form>
                </div>
            </div>
        </div>
